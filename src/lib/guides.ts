...
export interface GuideDefinition {
  ...
  /** meta description。 */
  description: string;
  /** 導入文（200〜300字、手書き）。「テーマから探す」ハブページのカード紹介文にも使う。 */
  intro: string;
  /** 関連ガイドへのリンク用slug。 */
  relatedSlugs: string[];
...
export const GUIDES: GuideDefinition[] = [
  {
    ...
    intro:
      '三条という街そのものは、決して眠らない街ではない。それでも本寺小路の灯りは、日付が変わっても消えない。中心市街地でこれほど遅くまで表に灯りが漏れる路地は、実はそう多くない。高度経済成長期からこの路地の灯りは絶やされることなく受け継がれてきたというが、深夜まで営業する店の存在もその一部だろう。仕事終わりが遅くなった日も、飲み会の後にもう一軒欲しくなった夜も、ここなら受け止めてくれる店がある。日付をまたいでも通える、本寺小路の店をまとめた。',
  ...
  },
  {
    ...
    intro:
      '三条が金物と鍛冶の町として栄えた高度経済成長期、本寺小路には料亭や小料理屋、スナックが軒を連ね、夜ごと賑わったという。その名残もあってか、路地には今も店が肩を寄せ合うように並んでいる。だから他の街のように移動に気を遣わず、何軒でも歩いて回れる。1軒目は居酒屋で腹ごしらえをしながら夜のペースを作り、2軒目はBARやスナックでじっくり語らい、〆はラーメンやおでんで締めくくる。〆まで路地一本で完結する密度こそが、この街の贅沢さだ。その流れに沿って、店を並べた。',
  ...
  },
  {
    ...
    intro:
      '三条は決して大きな街ではない。だからこそ本寺小路には、一人でふらりと立ち寄れる店が多い。昭和レトロな看板建築の細い間口をくぐると、たいていカウンターが客を迎える。出張や一人旅でこの路地に迷い込んだ夜も、勝手はさほど変わらない。大将や女将と少し言葉を交わすうちに、一見さんもいつしか顔なじみになっていく。それがこの路地に今も残る独特の距離感だ。スマートフォンから顔を上げて、目の前の一杯と会話を味わえる、カウンターのある店だけを集めた。',
  ...
  },
  {
    ...
    intro:
      '飲み会がお開きになった後、まっすぐ帰るには少し名残惜しい夜がある。本寺小路には、そんな気分を受け止める最後の一軒がある。1軒目、2軒目と重ねてきた夜も、ここでは他の街まで足を延ばさず、路地の中だけで完結する。にぎやかな居酒屋の後に、静かにグラスを傾けられる店。ラーメンやおでんで小腹を満たしてから帰る夜もある。〆まで路地一本で完結できるのが、この街の贅沢さだ。今夜の〆に、ふらりと寄れる店をまとめた。',
  ...
  },
  {
    ...
    intro:
      '本寺小路は、無理をして着飾って行くような街ではない。金物と鍛冶の町として栄えた三条には、腕一本で稼いだ金を気取らず使う職人気質が今も息づいている。ここに通うのは観光客より地元の常連が多く、店の値付けもその感覚に合わせて無理がない。仕事帰りのままふらりと立ち寄り、ほどよく飲んで、財布を気にせず帰れる。そのくらいの距離感が、この路地の性分に合っている。3,000円台で楽しめる、本寺小路らしい店をまとめた。',
...
export const GUIDES_HUB_INTRO =
  '本寺小路は決して広い路地ではないが、一晩の過ごし方はいくつもある。深夜まで飲みたい夜、一人でふらりと立ち寄りたい夜、何軒か重ねて歩きたい夜。同じ路地でも、その日の気分によって選ぶ店は変わってくる。ジャンルだけでは伝わらない、夜の目的別に本寺小路の店をまとめた。';
