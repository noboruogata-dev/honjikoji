...
export const ILLUST_DIMENSIONS: Record<string, { w: number; h: number }> = {
  ...
  // 高解像度版（800x800、透過処理済み）に差し替え済み。era-showaのみ
  // timeline配列で未使用のため旧200x200版のまま残す。
  '/images/timeline/era-edo.webp': { w: 800, h: 800 },
  '/images/timeline/era-heisei.webp': { w: 800, h: 800 },
  '/images/timeline/era-meiji-taisho.webp': { w: 800, h: 800 },
  '/images/timeline/era-reiwa.webp': { w: 800, h: 800 },
