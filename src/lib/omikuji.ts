...
export const OMIKUJI_TEXTS: Record<string, string[]> = {
  manto: [
    ...
    '今夜は誰の誘いも断るな。灯りはすべて、あなたの味方だ。',
    '今夜は奢れ。それだけの甲斐が、あなたにはある。',
    '路地の一番奥まで歩け。今夜だけは、迷わずたどり着ける。',
    'ハシゴを恐れるな。今夜は何軒目でも、うまい酒が待っている。',
    '今夜出会う人とは、また会うことになる。名前を覚えておけ。',
  ],
  oochouchin: [
    '二軒目まで迷わず行け。今夜の勘は当たる。',
    ...
    '今夜の一杯目は、いつもと違う酒を頼め。',
    '一杯目を選ぶのに迷うな。直感で頼め、それが正解だ。',
    '今夜は少し遅くまで灯りをたどれ。損はしない。',
    '知らない誰かと乾杯しろ。今夜の縁は悪くない。',
    '路地の看板をひとつ、じっくり眺めてみろ。行き先はそこにある。',
    '今夜は財布より、時計を気にするな。',
  ],
  akari: [
    '一軒目で長居するな。灯りは奥にもある。',
    ...
    '今夜は名物を頼め。定番には理由がある。',
    '知らない路地を覗いてみろ。灯りが待っている。',
    '今夜は少しだけ長く話せ。腰を上げるのは、それからでいい。',
    '一軒目の余韻が残るうちに、二軒目を決めろ。',
    '今夜は誰かに一杯おごれ。夜が少し軽くなる。',
  ],
  tentou: [
    ...
    '今夜は静かな一軒目を選べ。締めは賑やかでいい。',
    'つまみは一つ多めに頼め。今夜はそれくらいでちょうどいい。',
    '隣の店の灯りが気になったら、次はそこへ行け。',
    '一杯目のペースを守れ。今夜はそれで十分うまくいく。',
    '今夜の会計は、細かく気にするな。',
  ],
  koakari: [
    ...
    '今夜は多くを求めるな。一杯で十分な夜もある。',
    '一軒目で満足したら、それで終えていい。',
    '今夜は誰かに合わせず、自分のペースで飲め。',
    '無理に会話を広げるな。黙って飲む夜もいい。',
    '今夜は早めの一軒で、静かに終えろ。',
  ],
  hakumei: [
    ...
    '今夜は誘いを断ってもいい。無理に灯りを求めるな。',
    '一杯で切り上げても、後悔はしない夜だ。',
    '今夜は財布を開く前に、一度深呼吸しろ。',
    '灯りが弱く見えても、それが今夜の身の丈だ。',
    '今夜は早めに帰り支度をしろ。',
  ],
  kie: [
  ...
  nushi: [
    ...
    'あなたが選んだ夜に、路地の方が応える。今夜だけは、迷いを捨てろ。',
    '千夜に一度の巡り合わせ。今夜だけは、時計を見るな。',
    '灯りが揺れて、あなたを呼んでいる。応えろ。',
  ],
};
...
/**
 * お告げ文言を「。」（全角句点）単位の文に分割する。表示側
 * （src/components/OmikujiButton.astro）が、ブラウザ任意の折り返しでは
 * なく句点ごとに改行するために使う（各文を<br>で連結する）。
 * 末尾の句点で区切って生じる空文字列は含めない。句点を含まない
 * テキストを渡した場合は、そのまま1件だけの配列を返す。
 */
